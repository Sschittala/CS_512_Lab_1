...
\begin{itemize}
	...
	\textcolor{b}{** ADD UPDATED PLOTS HERE ** The script \textbf{code/q4\_sdg.py} contains the code that runs SGD, momentum, and LBFGS optimizations and records the training objective value and word-wise error for the plots.}
	...
	\textcolor{b}{The pseudocode is labeled as \textbf{Algorithm 1} on the next page and has been converted into latex readable pseudocode using the help of ChatGPT.}
