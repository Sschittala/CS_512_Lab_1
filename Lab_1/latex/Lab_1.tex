...
\begin{itemize}
	...
	\textcolor{b}{NEED TO ADD REVISED PLOTS FOR 4bii AND OBSERVATIONS HERE}
	...
	\textcolor{b}{The pseudocode is labeled as \textbf{Algorithm 1} has been converted into latex readable pseudocode using the help of ChatGPT.}
	...
	\textcolor{b}{The KL divergence for the Node and Edge with RB has a faster convergence than the Node and Edge values without. Therefore, RB is effective at reduciing variance. Another small piece to note is that Node marginals are easier to estimate than Edge marginals, but RB improves them both.}
