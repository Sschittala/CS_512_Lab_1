...
\begin{itemize}
	...
	\textcolor{b}{See \textbf{code/q1\_decode.py} for implmentation and \textbf{result/decode\_output.txt} for results. Need to include "maximum objective value" here, and add comments in the q1\_decode.py file.}
\end{itemize}
...
\textcolor{b}{The full folder for this model and its executables is under code/svm\_hmm}
