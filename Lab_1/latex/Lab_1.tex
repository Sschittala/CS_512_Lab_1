...
\begin{itemize}
	...
	\textcolor{b}{See code/q1 decode.py for implementation and result/decode output.txt for results. The maximum objective value obtained was 200.18}
\end{itemize}
...
\begin{itemize}
	...
	\textcolor{b}{See code/q2 gradient.py for implementation and result/gradient.txt for results. Average log p(y—X) over training set is -31.288437439649137}
...
\textcolor{b}{See code/q2 gradient.py for implementation and result/solution.txt, result/prediction for
results. Optimal objective value reported was 3704.963478698609.}
